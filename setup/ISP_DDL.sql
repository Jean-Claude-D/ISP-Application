...
CREATE TABLE INTERNET_PACKAGE (
	...
	SPEED_UPLOAD_MBPS NUMBER(7,3),
	SPEED_DOWNLOAD_MBPS NUMBER(7,3),
	/* LIMIT FOR BOTH UPLOAD AND DOWNLOAD */
	BANDWIDTH_GB NUMBER(7,3),
	/* HOW MUCH IT COSTS FOR ISP TO PROVIDE PACKAGE */
	RUNNING_COST NUMBER(7,2),
	MONTHLY_PRICE NUMBER(7,2),
	/* PGB = PER GB */
	OVERAGE_COST_PGB NUMBER(7,2),
...
CREATE TABLE EXTRA_FEATURE (
	...
	PRIMARY KEY (NAME),
	CONSTRAINT EXTRA_FEATURE_PER_GB_CHECK
  	CHECK (PER_GB IN ('1', '0'))
);
...
CREATE TABLE SALES_CALL (
	...
	ON DELETE CASCADE,
	CONSTRAINT SALES_CALL_SUCCESS_CHECK
